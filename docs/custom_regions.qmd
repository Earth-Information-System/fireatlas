...
```
{"regnm": "PlaceExample", "bbox": "[97.16172779881556,46.1226744036175,168.70469654881543,77.81982396998427]", "reg_shp": "", "tst": "[2024,5,1,\"AM\"]", "ted": "[2024,6,1,\"PM\"]", "operation": "--coordinate-all"}
```

::: callout-note
You can use a bounding box as shown above to define the region, or override the bbox parameter by passing the name of a shapefile that exists in the FEDSinput/Shapefiles to use this custom geometry to set the region bounds instead.
:::
...
2. Edit the new workflow and make sure to change some of the following sections and values. Note that leaving `tst` or `ted` as `[]` means it will run from current year 01/01 to now:
   ...
   ...
      ...
      with:
        ...
        json_params: '{"regnm": "RussiaEast", "bbox": "[97.16172779881556, 46.1226744036175, 168.70469654881543, 77.81982396998427]", "reg_shp": "", "tst": "[2024,5,1,\"AM\"]", "ted": "[]", "operation": "--coordinate-all"}'
   ```
