...
def t_nm(t: tuple, nb: str):
    """
    Returns the date of the first day next month or the last day of the previous
    month given a TimeStep.

    Parameters
    ----------
    t : tuple, (int, int, int (optional), str (optional))
        A tuple with (y, m, d (optional) and AM/PM (optional))
    nb : str, 'next'|'previous'
        option to specify the desired month
