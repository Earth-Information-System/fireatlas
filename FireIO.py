...
def read_AFPVIIRS(t, region, sat='SNPP',cols=['Lat','Lon','FRP','Sat','DT','DS','YYYYMMDD_HHMM','ampm','x','y']):
...
def read_AFPVIIRSNRT(t, region, sat='SNPP', cols=['Lat','Lon','FRP','Sat','DT','DS','YYYYMMDD_HHMM','ampm','x','y']):
